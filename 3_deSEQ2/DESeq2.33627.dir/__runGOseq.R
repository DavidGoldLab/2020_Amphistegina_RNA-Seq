...
factor_labeling = read.table("RSEM.gene.counts.matrix.Low_vs_Reg.DESeq2.DE_results.P0.001_C2.DE.subset", row.names=1)
...
background = read.table("RSEM.gene.counts.matrix.Low_vs_Reg.DESeq2.count_matrix", header=T, row.names=1)
...
go_enrich_filename = paste("RSEM.gene.counts.matrix.Low_vs_Reg.DESeq2.DE_results.P0.001_C2.DE.subset", '.GOseq.enriched', sep='')
    ...
    go_depleted_filename = paste("RSEM.gene.counts.matrix.Low_vs_Reg.DESeq2.DE_results.P0.001_C2.DE.subset", '.GOseq.depleted', sep='')
